...
namespace Keka.Clone.Persistence.Migrations
{
    ...
    [Migration("20251218054119_AddTeamsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Keka.Clone.Domain.Entities.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Keka.Clone.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("536c25a9-c588-4e24-a4c4-2e448f5ae605"),
                            CreatedAt = new DateTime(2025, 12, 18, 5, 41, 19, 360, DateTimeKind.Utc).AddTicks(6006),
                            Email = "admin@keka.com",
                            FullName = "Admin",
                            IsActive = true,
                            PasswordHash = "AQAAAAIAAYagAAAAEMsBpk4M953pLo/sw5l5GaI+X5CXc0plCGxLwUZL0DxOZvMfM0cZTFto/5EPGplw9A==",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Keka.Clone.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Keka.Clone.Domain.Entities.Team", "Team")
                        .WithMany("Employees")
